 ...
 * More or less a link to two different nodes.
 *
 * @author Curtis moore
 */
public class Edge {
   ...
   * @param node2 second node to link to.
   */
  ...
  /**
   * Given a node, tells you the other node.
   * Or null if the given node DNE.
   *
   * @param node that is not returned
   * @return the node other than the given, or null if the given node is not on this graph.
   */
